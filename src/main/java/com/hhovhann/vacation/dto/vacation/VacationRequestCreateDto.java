...
public class VacationRequestCreateDto {
    @JsonProperty("id")
    @Schema(name = "Vacation Request ID", example = "2f8c7305-08e7-4ed5-a998-089ef1672c25", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    UUID entityId;
    ...
    @Schema(name = "Vacation request creation date", example = "2024-08-09T12:57:13.506Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
